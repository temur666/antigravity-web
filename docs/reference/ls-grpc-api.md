...
- `CORTEX_STEP_TYPE_VIEW_FILE_OUTLINE` — 查看文件大纲
- `CORTEX_STEP_TYPE_VIEW_CODE_ITEM` — 查看代码项
- `CORTEX_STEP_TYPE_GREP_SEARCH` — Grep 搜索
- `CORTEX_STEP_TYPE_FIND` — 查找文件
- `CORTEX_STEP_TYPE_CODE_ACKNOWLEDGEMENT` — 确认代码修改
